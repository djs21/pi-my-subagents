 ...
 * - Shows agent identity + available tools as a styled widget above the editor (toggle with Alt+O)
...
export default function (pi: ExtensionAPI) {
    ...
    ctx.ui.setWidget(
      ...
      (_tui: any, theme: any) => {
        ...
        if (expanded) {
          ...
          const hint = theme.fg("muted", "  (Alt+O to collapse)");
          ...
          const deniedInfo =
            denied.length > 0
              ...
              : "";
          const hint = theme.fg("muted", "  (Alt+O to expand)");
  ...
  // Toggle expand/collapse with Alt+O
